...
AnimSpriteComponent::AnimSpriteComponent(Actor* owner, int drawOrder)
	:SpriteComponent(owner, drawOrder) // Call the constructor of the inherited class
	, currentFrame(0.0f)
	, animFPS(24.0f)
	, currentAnimation("")
{}
...
void AnimSpriteComponent::addAnimation(const std::string animName, const std::vector<SDL_Texture*>& textures) {
...
bool AnimSpriteComponent::setCurrentAnimation(const std::string animName)
{
