// BGSpriteComponent2.cpp

#include "BGSpriteComponent2.h"
#include "Actor2.h"

BGSpriteComponent2::BGSpriteComponent2(Actor2* owner, int drawOrder)
...
void BGSpriteComponent2::update(float deltatime) {
...
void BGSpriteComponent2::draw(SDL_Renderer* renderer) {
...
void BGSpriteComponent2::setBackgroundTextures(const std::vector<SDL_Texture*>& textures) {
